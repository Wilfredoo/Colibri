// there is something abotu audio permissions here
...
class App extends Component {
  ...
  render() {
    ...
    let countDownLayout = this.state.isStartedRecord
    ...
    return (
      <View style={styles.container}>
        <StatusBar hidden={true} />
          ...
          >
            {/* <View style={this.state.isStartedRecord ? styles.countDownGroup : { display: 'none', }}>
              <Entypo name="controller-record" size={20} style={{ color: 'red', }} />
              <Text style={{ color: '#000', }}>{this.state.minuteLabel}:{this.state.secondLabel}</Text>
            </View> */}
            {countDownLayout}
